...
// Store's WhatsApp contact number, wa.me deep-link format (country code, no
// leading +/00/spaces). Currently the store owner's own number for testing —
// swap for the real store number before this ships for real.
const WHATSAPP_NUMBER = "972595737545";

// Exported for reuse by the admin order detail page's contact button
// (see OrderDetail.tsx's showWhatsAppButton prop) — same glyph, no reason
// to duplicate the path data.
