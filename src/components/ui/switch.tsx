  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          // translate-x is a physical transform (unlike Tailwind's logical
          // ms-/me-/start-/end- utilities), so it doesn't mirror under
          // dir="rtl" on its own — same class of bug HeroCarousel's Ken
          // Burns pan hit, fixed the same way: an explicit rtl: sign flip.
          // unchecked's translate-x-0 needs no rtl: variant since 0 is
          // direction-neutral.
